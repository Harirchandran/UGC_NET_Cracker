...
raster_tests = [
    ...
    ('img SVG reference', {'question': '<img src="diagram.svg"> What is this?'}, True),
    ('object SVG reference', {'question': '<object data="diagram.svg">Missing</object>'}, True),
    ('embed SVG reference', {'question': '<embed src="diagram.svg" type="image/svg+xml">'}, True),
    ('iframe external src', {'question': '<iframe src="https://example.com/question"></iframe>'}, True),
    ('CSS url SVG', {'question': '<div style="background-image:url(diagram.svg)"></div>'}, True),
    ('local relative SVG path', {'question': '<img src="../assets/question.svg">'}, True),
    ...
    ('textual SVG mention', {'question': 'SVG files are scalable vector graphics.'}, False),
    ('bare img mention', {'question': 'The <img> tag is used in HTML.'}, False),
    ('harmless URL in text', {'question': 'Refer to https://example.com for details.'}, False),
